...
HTML;
	...
	/**************************************************************************
	 generateSearchIcon()
	 **************************************************************************/
	function generateSearchIcon($search, $slide = false)
	{
		$paneId = $this->Mint->cfg['pepperShaker'][$this->pepperId]['panes'][0];
		$slideJS = ($slide) ? "SI.Scroll.to('pane-{$paneId}');" : '';
		return '<a href="#search" title="Search for this session in the Crushes pane" onclick="'.$slideJS.'return SI_crushSearch(\''.$search.'\');"><img src="styles/vanilla_mint/images/icon-search.png" width="12" height="12" alt="Search" /></a>';
	}
}