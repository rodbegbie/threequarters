from threequarters.comments.models import Comment, FreeComment
from threequarters.comments.models import PHOTOS_REQUIRED, PHOTOS_OPTIONAL, RATINGS_REQUIRED, RATINGS_OPTIONAL, IS_PUBLIC
from threequarters.comments.models import MIN_PHOTO_DIMENSION, MAX_PHOTO_DIMENSION
...
class CommentFormNode(template.Node):
    ...
    def render(self, context):
        ...
        if self.free:
            context['hash'] = Comment.objects.get_security_hash(context['options'], '', '', context['target'], context['request'].META["HTTP_X_FORWARDED_FOR"])
            ...
            context['hash'] = Comment.objects.get_security_hash(context['options'], context['photo_options'], context['rating_options'], context['target'], context['request'].META["HTTP_X_FORWARDED_FOR"])
